...
const Story = () => {
  return (
    <div className="relative flex flex-col w-full md:flex-row max-width md:gap-x-6 lg:gap-x-0 py-14 ">
      ...
      />
      <div className="py-6 sm:py-10 w-full sm:w-[90vw] left-0 right-0 mx-auto  md:w-[500px] flex flex-col justify-center items-start px-6  absolute md:static bottom-0 sm:bottom-10 bg-white">
        <p>OUR STORY</p>
